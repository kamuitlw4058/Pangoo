namespace Pangoo.Common.Utility
{
    ...
    {
        private static IStringFormatHelper s_TextHelper = null;

        /// <summary>
        /// 设置字符辅助器。
        /// </summary>
        /// <param name="textHelper">要设置的字符辅助器。</param>
        public static void SetTextHelper(IStringFormatHelper textHelper)
        {
        ...
        public static string Format<T>(string format, T arg)
        {
            if (format == null)
            {
                throw new PangooCommonException("Format is invalid.");
            }
