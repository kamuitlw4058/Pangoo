...
namespace Pangoo.Common.Alloc
{
    ...
    public static partial class ReferencePool
    {
        ...
        public static void Release(IReference reference)
        {
            if (reference == null)
            {
                throw new PangooCommonException("Reference is invalid.");
            }
        ...
        private static void InternalCheckReferenceType(Type referenceType)
        {
            ...
            {
                throw new PangooCommonException("Reference type is invalid.");
            }

            if (!referenceType.IsClass || referenceType.IsAbstract)
            {
                throw new PangooCommonException("Reference type is not a non-abstract class type.");
            }

            if (!typeof(IReference).IsAssignableFrom(referenceType))
            {
                throw new PangooCommonException(StringFormat.Format("Reference type '{0}' is invalid.", referenceType.FullName));
            }
        }
        ...
        private static ReferenceCollection GetReferenceCollection(Type referenceType)
        {
            if (referenceType == null)
            {
                throw new PangooCommonException("ReferenceType is invalid.");
            }
