...
namespace Pangoo.MetaTable
{
    ...
    public partial class VariablesTable : MetaTableBase,IVariablesTable
    {
        ...
        public Dictionary<string, IVariablesRow> RowDict = new Dictionary<string, IVariablesRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IVariablesRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IVariablesRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IVariablesRow row))
            {
                return row;
            }
            return null;
