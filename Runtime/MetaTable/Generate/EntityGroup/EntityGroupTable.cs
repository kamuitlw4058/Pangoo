...
namespace Pangoo.MetaTable
{
    ...
    public partial class EntityGroupTable : MetaTableBase,IEntityGroupTable
    {
        ...
        public Dictionary<string, IEntityGroupRow> RowDict = new Dictionary<string, IEntityGroupRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IEntityGroupRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IEntityGroupRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IEntityGroupRow row))
            {
                return row;
            }
            return null;
