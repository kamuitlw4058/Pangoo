...
namespace Pangoo.MetaTable
{
    ...
    public partial class ConditionOverview : MetaTableOverview
    {
        ...
        public static UnityConditionRow GetUnityRowById(int id, string packageDir = null)
        {
           var overviews = AssetDatabaseUtility.FindAsset<ConditionOverview>(packageDir);
        ...
        {
           return GetUuidDropdown<ConditionOverview>(excludeUuids: excludeUuids, packageDir: packageDir);
        }
