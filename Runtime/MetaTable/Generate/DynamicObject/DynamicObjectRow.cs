...
namespace Pangoo.MetaTable
{
    ...
    public partial class DynamicObjectRow : MetaTableRow,IDynamicObjectRow
    {
        ...
        [JsonMember("NameCn")]
        [MetaTableRowColumn("NameCn","string", "中文名",2)]
        [LabelText("中文名")]
        ...
        [JsonMember("Space")]
        [MetaTableRowColumn("Space","string", "位置空间",3)]
        [LabelText("位置空间")]
        public string Space ;
        ...
        [JsonMember("Position")]
        [MetaTableRowColumn("Position","Vector3", "位置",4)]
        [LabelText("位置")]
        ...
        [JsonMember("Rotation")]
        [MetaTableRowColumn("Rotation","Vector3", "旋转",5)]
        [LabelText("旋转")]
        ...
        [JsonMember("Scale")]
        [MetaTableRowColumn("Scale","Vector3", "缩放",6)]
        [LabelText("缩放")]
        ...
        [MetaTableRowColumn("UseHotspot","bool", "使用热点区域",7)]
        [LabelText("使用热点区域")]
        ...
        [MetaTableRowColumn("DefaultHideHotspot","bool", "默认关闭热点",8)]
        [LabelText("默认关闭热点")]
        ...
        [MetaTableRowColumn("HotspotRadius","float", "热点区域的范围",9)]
        [LabelText("热点区域的范围")]
        ...
        [MetaTableRowColumn("HotspotOffset","Vector3", "热点区域偏移",10)]
        [LabelText("热点区域偏移")]
        ...
        [MetaTableRowColumn("DirectInstructions","string", "直接指令",11)]
        [LabelText("直接指令")]
        ...
        [MetaTableRowColumn("SubDynamicObject","string", "子物体",12)]
        [LabelText("子物体")]
        ...
        [MetaTableRowColumn("InteractRadius","float", "可交互半径",13)]
        [LabelText("可交互半径")]
        ...
        [MetaTableRowColumn("InteractOffset","Vector3", "交互点偏移",14)]
        [LabelText("交互点偏移")]
        ...
        [MetaTableRowColumn("InteractRadian","float", "可交互角度",15)]
        [LabelText("可交互角度")]
        ...
        [MetaTableRowColumn("InteractTarget","string", "交互对象",16)]
        [LabelText("交互对象")]
        ...
        [MetaTableRowColumn("DefaultHideModel","bool", "默认隐藏模型",17)]
        [LabelText("默认隐藏模型")]
        ...
        [MetaTableRowColumn("AssetPathUuid","string", "AssetPathUuid",18)]
        ...
        [MetaTableRowColumn("DefaultDisableInteract","bool", "默认关闭交互",19)]
        [LabelText("默认关闭交互")]
        ...
        [MetaTableRowColumn("TriggerEventUuids","string", "TriggerEventUuids",20)]
        ...
        [MetaTableRowColumn("HotspotUuids","string", "HotspotUuids",21)]
        ...
        [MetaTableRowColumn("PreviewName","string", "预览名字",22)]
        [LabelText("预览名字")]
        ...
        [MetaTableRowColumn("PreviewDesc","string", "预览描述",23)]
        [LabelText("预览描述")]
        ...
        [MetaTableRowColumn("StateSubDynamicObject","string", "状态子物体",24)]
        [LabelText("状态子物体")]
        ...
        [MetaTableRowColumn("StateVariableUuid","string", "状态变量Uuid",25)]
        [LabelText("状态变量Uuid")]
        ...
        [MetaTableRowColumn("PreviewRotation","Vector3", "预览旋转",26)]
        [LabelText("预览旋转")]
        ...
        [MetaTableRowColumn("PreviewScale","Vector3", "预览缩放",27)]
        [LabelText("预览缩放")]
        ...
        [MetaTableRowColumn("SubObjectTriggerList","string", "子物体触发器列表",28)]
        [LabelText("子物体触发器列表")]
        ...
        [MetaTableRowColumn("MouseInteractList","string", "鼠标交互列表",29)]
        [LabelText("鼠标交互列表")]
        ...
        [JsonMember("ColliderTriggerStayTimeout")]
        [MetaTableRowColumn("ColliderTriggerStayTimeout","float", "ColliderTrigger超时",30)]
        [LabelText("ColliderTrigger超时")]
        public float ColliderTriggerStayTimeout ;

        float IDynamicObjectRow.ColliderTriggerStayTimeout {get => ColliderTriggerStayTimeout; set => ColliderTriggerStayTimeout = value;}

        [JsonMember("ColliderTriggerStayExitDelay")]
        [MetaTableRowColumn("ColliderTriggerStayExitDelay","float", "ColliderTrigger退出超时延迟",31)]
        [LabelText("ColliderTrigger退出超时延迟")]
