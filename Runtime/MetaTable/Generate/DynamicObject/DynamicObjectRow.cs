...
namespace Pangoo.MetaTable
{
    ...
    public partial class DynamicObjectRow : MetaTableRow,IDynamicObjectRow
    {
        ...
        [MetaTableRowColumn("ModelList","string", "模型列表",3)]
        [LabelText("模型列表")]
        public string ModelList ;

        string IDynamicObjectRow.ModelList {get => ModelList; set => ModelList = value;}
        ...
        [MetaTableRowColumn("ColliderTriggerStayTimeout","float", "ColliderTrigger超时",31)]
        ...
        [MetaTableRowColumn("ColliderTriggerStayExitDelay","float", "ColliderTrigger退出超时延迟",32)]
