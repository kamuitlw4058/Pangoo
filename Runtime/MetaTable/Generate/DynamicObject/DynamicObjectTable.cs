...
namespace Pangoo.MetaTable
{
    ...
    public partial class DynamicObjectTable : MetaTableBase,IDynamicObjectTable
    {
        ...
        public Dictionary<string, IDynamicObjectRow> RowDict = new Dictionary<string, IDynamicObjectRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IDynamicObjectRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IDynamicObjectRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IDynamicObjectRow row))
            {
                return row;
            }
            return null;
