...
namespace Pangoo.MetaTable
{
    ...
    public partial class ActorsLinesOverview : MetaTableOverview
    {
        ...
        public static UnityActorsLinesRow GetUnityRowById(int id, string packageDir = null)
        {
           var overviews = AssetDatabaseUtility.FindAsset<ActorsLinesOverview>(packageDir);
