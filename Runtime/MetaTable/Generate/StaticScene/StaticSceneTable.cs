...
namespace Pangoo.MetaTable
{
    ...
    public partial class StaticSceneTable : MetaTableBase,IStaticSceneTable
    {
        ...
        public Dictionary<string, IStaticSceneRow> RowDict = new Dictionary<string, IStaticSceneRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IStaticSceneRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IStaticSceneRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IStaticSceneRow row))
            {
                return row;
            }
            return null;
