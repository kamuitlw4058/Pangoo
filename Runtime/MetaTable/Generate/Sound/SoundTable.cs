...
namespace Pangoo.MetaTable
{
    ...
    public partial class SoundTable : MetaTableBase,ISoundTable
    {
        ...
        public Dictionary<string, ISoundRow> RowDict = new Dictionary<string, ISoundRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as ISoundRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as ISoundRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out ISoundRow row))
            {
                return row;
            }
            return null;
