...
namespace Pangoo.MetaTable
{
    ...
    public partial class TriggerEventTable : MetaTableBase,ITriggerEventTable
    {
        ...
        public Dictionary<string, ITriggerEventRow> RowDict = new Dictionary<string, ITriggerEventRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as ITriggerEventRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as ITriggerEventRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out ITriggerEventRow row))
            {
                return row;
            }
            return null;
