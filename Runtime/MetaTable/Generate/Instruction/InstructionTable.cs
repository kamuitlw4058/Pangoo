...
namespace Pangoo.MetaTable
{
    ...
    public partial class InstructionTable : MetaTableBase,IInstructionTable
    {
        ...
        public Dictionary<string, IInstructionRow> RowDict = new Dictionary<string, IInstructionRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IInstructionRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IInstructionRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IInstructionRow row))
            {
                return row;
            }
            return null;
