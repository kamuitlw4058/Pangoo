...
namespace Pangoo.MetaTable
{
    ...
    public partial class AssetPathTable : MetaTableBase,IAssetPathTable
    {
        ...
        public Dictionary<string, IAssetPathRow> RowDict = new Dictionary<string, IAssetPathRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IAssetPathRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IAssetPathRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IAssetPathRow row))
            {
                return row;
            }
            return null;
