...
namespace Pangoo.MetaTable
{
    ...
    public partial class HotspotTable : MetaTableBase,IHotspotTable
    {
        ...
        public Dictionary<string, IHotspotRow> RowDict = new Dictionary<string, IHotspotRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IHotspotRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IHotspotRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IHotspotRow row))
            {
                return row;
            }
            return null;
