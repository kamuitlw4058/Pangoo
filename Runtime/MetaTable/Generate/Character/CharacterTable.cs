...
namespace Pangoo.MetaTable
{
    ...
    public partial class CharacterTable : MetaTableBase,ICharacterTable
    {
        ...
        public Dictionary<string, ICharacterRow> RowDict = new Dictionary<string, ICharacterRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as ICharacterRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as ICharacterRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out ICharacterRow row))
            {
                return row;
            }
            return null;
