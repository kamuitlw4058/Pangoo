...
namespace Pangoo.MetaTable
{
    ...
    public partial class AssetGroupTable : MetaTableBase,IAssetGroupTable
    {
        ...
        public Dictionary<string, IAssetGroupRow> RowDict = new Dictionary<string, IAssetGroupRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as IAssetGroupRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as IAssetGroupRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out IAssetGroupRow row))
            {
                return row;
            }
            return null;
