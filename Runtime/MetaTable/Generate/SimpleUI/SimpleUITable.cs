...
namespace Pangoo.MetaTable
{
    ...
    public partial class SimpleUITable : MetaTableBase,ISimpleUITable
    {
        ...
        public Dictionary<string, ISimpleUIRow> RowDict = new Dictionary<string, ISimpleUIRow>();
               ...
               if (RowDict.ContainsKey(o.Uuid))
                {
                   ...
                   RowDict.Add(o.Uuid, o as ISimpleUIRow);
            }
        }
        ...
        public override void MergeRows(IReadOnlyList<IMetaTableRow> rows)
        {
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                {
                    RowDict.Add(rows[i].Uuid, rows[i] as ISimpleUIRow);
                }
            }
        }
        ...
        {
            if (RowDict.TryGetValue(uuid, out ISimpleUIRow row))
            {
                return row;
            }
            return null;
