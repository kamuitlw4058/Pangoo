...
namespace Pangoo
{
    public partial class AssetGroupTableOverview : ExcelTableOverview
    {


       public AssetGroupTable Data;

       public override ExcelTableBase GetExcelTableBase()
       {
           return CopyUtility.Clone<AssetGroupTable>(Data);
       }
