...
namespace Pangoo
{
    ...
    public sealed class PangooSceneComponent : GameFrameworkComponent
    {
        ...
        private void OnLoadSceneSuccess(object sender, GameFramework.Scene.LoadSceneSuccessEventArgs e)
        {
            ...
            m_EventComponent.Fire(this, UnityGameFramework.Runtime.LoadSceneSuccessEventArgs.Create(e));

            var sceneParams = e.UserData as SceneParams;
            Debug.Log($"Load scene params:{sceneParams.Active}");
            if (sceneParams.Active)
            {
            ...
            {
                Debug.Log($"Load scene Default m_GameFrameworkScene:{m_GameFrameworkScene.name}");
                SetActiveScene(m_GameFrameworkScene);
            }
        }
        ...
        private void OnLoadSceneFailure(object sender, GameFramework.Scene.LoadSceneFailureEventArgs e)
        {
            ...
            m_EventComponent.Fire(this, UnityGameFramework.Runtime.LoadSceneFailureEventArgs.Create(e));
        }

        private void OnLoadSceneUpdate(object sender, GameFramework.Scene.LoadSceneUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, UnityGameFramework.Runtime.LoadSceneUpdateEventArgs.Create(e));
        }

        private void OnLoadSceneDependencyAsset(object sender, GameFramework.Scene.LoadSceneDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs.Create(e));
        }

        private void OnUnloadSceneSuccess(object sender, GameFramework.Scene.UnloadSceneSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, UnityGameFramework.Runtime.UnloadSceneSuccessEventArgs.Create(e));
        ...
        private void OnUnloadSceneFailure(object sender, GameFramework.Scene.UnloadSceneFailureEventArgs e)
        {
            ...
            m_EventComponent.Fire(this, UnityGameFramework.Runtime.UnloadSceneFailureEventArgs.Create(e));
        }
    }
}
